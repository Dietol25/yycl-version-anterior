  ...
  const modalidades = [
    {
      ...
      accentColor: '#834296',
      // Gradiente suave y sutil al hacer hover
      hoverClasses: 'hover:bg-gradient-to-br hover:from-white hover:via-[#FAF5FF] hover:to-[#F3E8FF] hover:border-[#834296] hover:shadow-[6px_6px_0px_#834296]',
    ...
    },
    {
      ...
      accentColor: '#EC9519',
      // Gradiente cálido al hacer hover
      hoverClasses: 'hover:bg-gradient-to-br hover:from-white hover:via-[#FFFBEB] hover:to-[#FEF3C7] hover:border-[#EC9519] hover:shadow-[6px_6px_0px_#EC9519]',
    ...
    },
    {
      ...
      accentColor: '#4DC2DA',
      // Gradiente cyan/teal fresco al hacer hover
      hoverClasses: 'hover:bg-gradient-to-br hover:from-white hover:via-[#F0FDFA] hover:to-[#CCFBF1] hover:border-[#4DC2DA] hover:shadow-[6px_6px_0px_#4DC2DA]',
  ...
  return (
    <section className="py-20 lg:py-24 bg-gradient-to-b from-[#FDF8F3] via-white to-[#FDF8F3] border-t border-slate-100">
      <div className="max-w-[1280px] mx-auto px-5 lg:px-12">
        ...
        {/* 3 Interactive Cards con Gradient al hacer Hover */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto items-stretch">
          {modalidades.map((mod) => (
            <Link
              key={mod.id}
              href="/planes"
              className={`bg-white rounded-3xl p-7 sm:p-8 border-2 border-[#001837] shadow-[5px_5px_0px_#001837] flex flex-col justify-between transition-all duration-300 transform hover:-translate-y-2 cursor-pointer group ${mod.hoverClasses}`}
            >
              <div className="space-y-4">
                {/* Badge Oficial */}
                <div className="flex items-center justify-between">
                  <span className={`inline-block text-[11px] font-heading font-extrabold uppercase tracking-wider px-3.5 py-1 rounded-full border transition-colors ${mod.badgeColor}`}>
                    {mod.badge}
                  </span>
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity text-xs font-heading font-bold text-[#001837] flex items-center gap-1">
