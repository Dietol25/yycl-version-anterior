  ...
  return (
    <footer className="bg-yycl-purple text-white transition-colors">
        ...
        <div className="grid grid-cols-12 gap-6 xl:gap-8 pb-12 border-b border-white/15">
              ...
              {subscribed ? (
                <div className="bg-white text-[#001837] border border-black/10 shadow-[3px_3px_0px_#001837] rounded-2xl p-3.5 flex items-center gap-3 animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="text-left">
                    <p className="text-xs font-heading font-extrabold text-[#001837]">¡Suscripción confirmada!</p>
                    <p className="text-[11px] text-slate-600 font-body-regular">Te enviamos la bienvenida a tu correo.</p>
                  </div>
                </div>
              ) : (
          ...
          <div className="col-span-2 space-y-3.5 pl-2">
            ...
            <div className="flex items-center gap-4 text-white pt-1">
              <a href="https://instagram.com/yesyoucanlanguages" target="_blank" rel="noreferrer" className="text-white/90 hover:text-yycl-yellow transition-colors flex items-center justify-center w-8 h-8 rounded-lg hover:bg-white/10" aria-label="Instagram">
                <InstagramIcon size={20} />
              </a>
              <a href="https://x.com" target="_blank" rel="noreferrer" className="text-white/90 hover:text-yycl-yellow transition-colors flex items-center justify-center w-8 h-8 rounded-lg hover:bg-white/10" aria-label="X">
                <XIcon size={18} />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-white/90 hover:text-yycl-yellow transition-colors flex items-center justify-center w-8 h-8 rounded-lg hover:bg-white/10" aria-label="LinkedIn">
                <LinkedinIcon size={19} />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="text-white/90 hover:text-yycl-yellow transition-colors flex items-center justify-center w-8 h-8 rounded-lg hover:bg-white/10" aria-label="YouTube">
                <YoutubeIcon size={21} />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-white/90 hover:text-yycl-yellow transition-colors flex items-center justify-center w-8 h-8 rounded-lg hover:bg-white/10" aria-label="Facebook">
      ...
      <div className="block lg:hidden px-5 py-8 space-y-6 max-w-sm mx-auto">
        ...
        {/* Mobile Newsletter Form with explicit response */}
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3 text-white pt-1">
            <a href="https://instagram.com/yesyoucanlanguages" target="_blank" rel="noreferrer" className="text-white hover:text-yycl-yellow p-2 rounded-lg bg-white/10" aria-label="Instagram">
              <InstagramIcon size={20} />
            </a>
            <a href="https://x.com" target="_blank" rel="noreferrer" className="text-white hover:text-yycl-yellow p-2 rounded-lg bg-white/10" aria-label="X">
              <XIcon size={18} />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-white hover:text-yycl-yellow p-2 rounded-lg bg-white/10" aria-label="LinkedIn">
              <LinkedinIcon size={19} />
            </a>
            <a href="https://youtube.com" target="_blank" rel="noreferrer" className="text-white hover:text-yycl-yellow p-2 rounded-lg bg-white/10" aria-label="YouTube">
              <YoutubeIcon size={21} />
            </a>
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-white hover:text-yycl-yellow p-2 rounded-lg bg-white/10" aria-label="Facebook">
              <FacebookIcon size={19} />
            </a>
          </div>
        </div>
