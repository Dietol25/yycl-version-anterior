  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white border-b border-black/10 transition-all duration-200">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12 h-16 sm:h-[68px] flex items-center justify-between">
          {/* Brand Logo Sticker (44px) — Cumple función estándar de Inicio */}
          ...
          <div className="flex xl:hidden items-center gap-2.5">
            ...
            <button
              ...
              className="p-1.5 text-[#001837] hover:bg-slate-100 rounded-xl focus:outline-none cursor-pointer"
