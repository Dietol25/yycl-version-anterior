...
// Lista ampliada de testimonios verificados con sus fuentes reales
const VERIFIED_TESTIMONIALS = [
  {
    id: '1',
    name: 'Yuliana Navarro',
    role: 'Estudiante de Inglés Conversacional',
    quote: 'Me han encantado... Me he permitido preguntar, hablar y lanzarme. Me gusta que no hay juzgamientos; por eso aprovecho cada clase al máximo.',
  ...
  },
  {
    ...
    quote: 'YYCL me ayudó a refrescar mis conocimientos y a practicar toda la teoría. Pude mejorar fluidez, gramática y vocabulario de forma fácil y con tiempo flexible.',
    avatar: '/assets/avatares/mujer.png',
    source: 'Google Reviews 5.0★',
    sourceUrl: GOOGLE_MAPS_REVIEWS_URL,
    countryFlag: '🇪🇨',
  ...
  },
  {
    ...
    quote: 'La flexibilidad horaria y que el profesor se enfoque 100% en conversación práctica fue lo que realmente marcó la diferencia frente a otros institutos.',
    avatar: '/assets/avatares/hombre.png',
    source: 'Google Reviews 5.0★',
    sourceUrl: GOOGLE_MAPS_REVIEWS_URL,
    countryFlag: '🇦🇷',
  },
  {
    ...
    quote: 'Nunca me sentí juzgada al cometer errores. El ambiente de confianza hace que hablar inglés se vuelva algo natural y hasta divertido.',
    avatar: '/assets/avatares/mujer.png',
