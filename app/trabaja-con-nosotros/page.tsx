        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-2xs space-y-2 text-center">
              ...
              <h3 className="font-heading font-bold text-sm text-[#001837]">Cultura Humana</h3>
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-2xs space-y-2 text-center">
              ...
              <h3 className="font-heading font-bold text-sm text-[#001837]">Flexibilidad 100% Remota</h3>
              <p className="text-xs text-slate-600 font-body-regular">
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-2xs space-y-2 text-center">
              ...
              <h3 className="font-heading font-bold text-sm text-[#001837]">Comunidad Real</h3>
              <p className="text-xs text-slate-600 font-body-regular">
