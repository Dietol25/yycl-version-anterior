...
fs.writeFileSync('components/ui/Button.tsx', buttonCode.trim());
fs.writeFileSync('components/ui/Badge.tsx', badgeCode.trim());
fs.writeFileSync('components/ui/FormInput.tsx', inputCode.trim());
