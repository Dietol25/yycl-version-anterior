...
export const Footer = () => {
  ...
  return (
    <footer className="bg-yycl-purple text-white transition-colors select-none">
      {/* ========================================================================= */}
      {/* DESKTOP FOOTER (>= lg screens - Exact 4-column distribution from image)   */}
      {/* ========================================================================= */}
      <div className="hidden lg:block max-w-[1280px] mx-auto px-8 lg:px-12 pt-14 pb-8">
        <div className="grid grid-cols-12 gap-6 xl:gap-8 pb-12 border-b border-white/15">
          {/* Col 1: Marca + Tagline + Newsletter compacto (4 cols) */}
          ...
          <div className="col-span-2 space-y-3.5 pl-2">
            ...
            <div className="flex items-center gap-4 text-white pt-0.5">
...
print("Footer layout updated to exact 4-column ideal distribution with newsletter")
