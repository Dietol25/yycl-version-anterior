  ...
  return (
    <section className="py-20 lg:py-24 bg-white border-t border-slate-100">
      <div className="max-w-[1280px] mx-auto px-5 lg:px-12">
        ...
        {/* Tab Content Pane with subtle border & shadow */}
        <div className="bg-gradient-to-br from-slate-50/80 to-white border-2 border-[#001837]/10 rounded-3xl p-8 sm:p-12 shadow-[4px_4px_0px_rgba(0,24,55,0.06)] transition-all duration-200 overflow-hidden">
        ...
        <div className="mt-20 pt-16 border-t border-slate-100 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="border-l-4 border-[#001837] pl-5 py-1 space-y-1">
              <h4 className="text-lg sm:text-xl font-heading font-bold text-[#001837]">
            ...
            <div className="border-l-4 border-transparent hover:border-[#834296] pl-5 py-1 space-y-1 transition-colors">
              <h4 className="text-lg sm:text-xl font-heading font-bold text-[#001837]">
            ...
            <div className="border-l-4 border-transparent hover:border-[#FFD203] pl-5 py-1 space-y-1 transition-colors">
              <h4 className="text-lg sm:text-xl font-heading font-bold text-[#001837]">
...
print("OfferingsTabWidget updated with vivid Category Colors for all tabs")
