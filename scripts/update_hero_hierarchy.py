      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            {/* 4. Dual Actions matching exact screenshot */}
            <div className="pt-3 flex flex-col sm:flex-row sm:items-center gap-5">
              <Link href="/agendar">
                <Button
                  variant="primary"
                  size="md"
              ...
              <Link
                href="/como-funciona"
                className="font-heading font-semibold text-base text-[#3C4C92] hover:text-[#001837] transition-colors py-2 px-1 text-center sm:text-left"
              >
...
print("HeroSection updated with exact type styles and color hierarchy")
