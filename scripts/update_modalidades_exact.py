      ...
      <div className="max-w-[1280px] mx-auto px-5 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
          {modalidades.map((mod, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-b from-[#D97706]/90 via-[#834296] to-[#834296] text-white rounded-3xl p-7 sm:p-8 border-2 border-[#001837] shadow-[4px_4px_0px_#001837] space-y-4"
            >
              <div>
...
print("ModalidadesSection updated to exact Figma visual with 0 CTAs and verbatim copy")
